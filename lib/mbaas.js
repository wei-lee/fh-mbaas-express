var connect = require('fh-connect'),
  ...
  reqValidator = require("./common/requestValidator"),
...
module.exports = connect().use(connect.bodyParser()).use(cors()).use(
  connect.router(function (app) {
    ...
    app.get('/forms/theme', function(req, res){
      var requestValidator = reqValidator(req);
    ...
    app.post('/forms/:submitId/:fieldId/:fileId/submitFormFileBase64', function(req, res){
      var requestValidator = reqValidator(req);
