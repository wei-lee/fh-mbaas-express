...
* Update the version number of fh-mbaas-api to include "~" 
* Update changelog to markdown file

## 3.0.3 - 17-06-2014 - IR230 - Niall Donnelly

* 7459 - Added increased limits to bodyparser.
